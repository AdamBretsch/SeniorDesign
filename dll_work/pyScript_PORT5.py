...
# Teensy port 1 0 ----- 37, 1 ---- 38



class Watcher:
    DIRECTORY_TO_WATCH = "/home/debian/SeniorDesign/teensyTransfer/csWrite/PORT_5"
...
def serialReceive(ser):
    ...
    f = open("/home/debian/SeniorDesign/teensyTransfer/pyWrite/PORT_5/DataFromTennsyFromPort5.txt","w")
    f.write(hexout + "\r\n")
    f.close()
    ser.close()
    ser.open()
