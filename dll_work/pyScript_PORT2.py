...
# Teensy port 1 0 ----- 21, 1 ---- 22



class Watcher:
    DIRECTORY_TO_WATCH = "/home/debian/SeniorDesign/teensyTransfer/csWrite/PORT_2"
...
def serialReceive(ser):
    ...
    f = open("/home/debian/SeniorDesign/teensyTransfer/pyWrite/PORT_2/DataFromTennsyFromPort2.txt","w")
    f.write(hexout + "\r\n")
    f.close()
    ser.close()
    ser.open()
